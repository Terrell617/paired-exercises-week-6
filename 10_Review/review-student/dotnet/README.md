...
There's a `BaseDaoTests` class that all the tests inherit from. This class sets up the test data for the integration tests to run against and then restores the original data. The requirements below explain what data you'll need to provide for the tests that you write.
